...
function GrayTopper() {
    ...
    return <div style={{height:250, background:"#212121", top:0, width:"100vw", marginBottom: -250}}>
...
function UpdateCard() {
    ...
    return <div style={{display:"flex", justifyContent:"center"}}>
        <Card variant="outlined" style={{maxWidth:600, marginTop:200, padding:20, width:"40vw"}}>
            <TextField 
                value={title}
...
function CourseCard(props) {
    ...
    return <div style={{display:"flex", marginTop: 50, justifyContent:"center", width: "100%"}}>
        <Card style={{
            margin:10, width:350, minHeight:200, 
            borderRadius:20, marginRight:50, 
            marginBottom:15, zIndex:2
        }}>
